...
- 🧠 [k-o11y-server](https://github.com/Wondermove-Inc/k-o11y-server) — 설치형 관측성 백엔드 (ko11y-core + 웹 UI)
...
- 🛂 [k-o11y-otel-gateway](https://github.com/Wondermove-Inc/k-o11y-otel-gateway) — License Guard 탑재 OTel Collector 배포판
